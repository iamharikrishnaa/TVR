  ...
  return (
    <div className="section relative" id="home">
      ...
      <div className="relative z-10 text-center">
        <div className="md:flex items-center justify-center">
          <div>
            <div className="sm:text-[2.5rem] mt-32 font-space-grotesk text-10xl text-white font-bold mx-auto">
              Indulge in Luxury <br /> Pampering at{" "}
              <span className="text-gold">
                The
                <br /> Velvet Room.
            ...
            <div className="mt-15 flex items-center justify-center">
              <button className="px-12 py-4 font-bold text-white bg-gold rounded-lg text-sm">
                Contact-Us
              </button>
            </div>
          </div>
